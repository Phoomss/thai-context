...
2. **คลังคำภาษาถิ่น 4 ภาค (Dialect Explorer):**
   - **สถานะปัจจุบัน:** ✅ **สมบูรณ์แล้ว (Completed)** ใน [`DialectExplorer.tsx`](file:///Users/mac/Desktop/workspace/thai-context/frontend/src/components/dialect/DialectExplorer.tsx)
   - **สิ่งที่ดำเนินการแล้ว:**
     - เชื่อมต่อชุดข้อมูลและจัดหมวดหมู่จริง (สนทนายอดนิยม, หมวดเครือญาติ ๓๔๖ รายการ, หมวดอวัยวะร่างกาย ๑,๑๐๒ รายการ) จาก `data/processed/dialects/`
     - เพิ่มตัวเลือกสลับหมวดหมู่คำ (Category Tabs) ชิปเลือกคำศัพท์ (Word Chips) และช่องค้นหาคำภาษาถิ่น (Live Search)
     - เพิ่มแถบฟังเสียงอ่านสำเนียงถิ่น (TTS Audio Integration) และสัทอักษร/คำอ่านกำกับ (`phonetic`)
     - แก้ไขความถูกต้องของภาษาถิ่นใต้คำว่า "คิดถึง" จากเดิมที่เป็นข้อผิดพลาด AI Inferred "ข้องใจถึง" ปรับเป็น "ข้องใจ" / "ขิดถึง" อย่างถูกต้องตามหลักภาษาศาสตร์ พร้อมตราสถานะ `[✓ ทางการ]` vs `[◌ อยู่ระหว่างตรวจสอบ]`
     - เพิ่ม API Endpoint รองรับ `GET /api/v1/dialect` และ `GET /api/v1/dialect/mapping/[word]` ใน [`route.ts`](file:///Users/mac/Desktop/workspace/thai-context/frontend/src/app/api/v1/dialect/route.ts) พร้อมทดสอบผ่าน Vitest ครบ 100%
